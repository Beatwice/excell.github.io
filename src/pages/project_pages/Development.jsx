        ...
        <div>
            ...
            <div className='container mx-auto px-24'>
                ...
                <div style={{marginBottom:'5px'}}>
                    <Link style={{marginRight:'10px'}} className='bg-blue-500 rounded-full font-semibold text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded' to="/project/development">DEVELOPMENT</Link>
                    <Link className='bg-transparent rounded-full hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded' to="/project/ui_design">UI DESIGN</Link>
                </div>
                <br />
