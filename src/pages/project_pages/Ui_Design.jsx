        ...
        <div>
            ...
            <div className='px-20 max-sm:px-0 max-sm:pt-2 max-sm:px-4 max-sm:px-0 pt-16 max-sm:pt-11'>
                ...
                <div style={{marginBottom:'5px'}}>
                    <Link style={{marginRight:'10px'}} className='bg-transparent rounded-full hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded max-sm:text-xs' to="/project/development">DEVELOPMENT</Link>
                    <Link className='bg-blue-500 rounded-full font-semibold text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded max-sm:text-xs' to="/project/ui_design">UI DESIGN</Link>
                </div>
                <br />
